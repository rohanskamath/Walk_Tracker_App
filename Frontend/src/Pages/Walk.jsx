...
const Walk = () => {
  ...
  useEffect(() => {
    //Getting All Walks
    axios.get("https://localhost:7018/api/Walk")
      .then((result) => {
    ...
    //Getting All Regions
    axios.get("https://localhost:7018/api/Regions")
      .then((result) => {
    ...
    axios.get("https://localhost:7018/api/Difficulty")
      .then((result) => {
  ...
  const handleRemove = () => {
    axios.delete(`https://localhost:7018/api/Walk/${selectedId}`)
      .then((result) => {
  ...
  const handleUpdate = () => {
    axios.put(`https://localhost:7018/api/Walk/${selectedId}`, editWalkData)
      .then((result) => {
        if (result.status === 200) {
  ...
  const handleSubmit = () => {
    axios.post("https://localhost:7018/api/Walk", walkData)
      .then((result) => {
        if (result.status === 200) {
