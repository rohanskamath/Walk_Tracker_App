...
const Regions = () => {
  ...
  const handleSubmit = () => {
    ...
    axios.post("https://localhost:7018/api/Regions", regionsData)
      .then((result) => {
  ...
  const handleUpdate = () => {
    axios.put(`https://localhost:7018/api/Regions/${selectedId}`, updateRegionsData)
      .then((result) => {
  ...
  const handleRemove = () => {
    axios.delete(`https://localhost:7018/api/Regions/${selectedId}`)
      .then((result) => {
        if (result.status === 200) {
